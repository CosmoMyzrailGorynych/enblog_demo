define(["handlebars"], function(Handlebars) { return Handlebars.template({"1":function(container,depth0,helpers,partials,data) {
  ...
  "<header>\r\n    <div class=\"inner\">\r\n        <h1><a href=\"/\">"
    ...
    + "    </div>\r\n</header>\r\n<nav class=\"aSiteNav\">\r\n    <div class=\"inner\">\r\n"
    + ((stack1 = helpers["if"].call(alias1,((stack1 = (depth0 != null ? depth0.global : depth0)) != null ? stack1.show_archive_link : stack1),{"name":"if","hash":{},"fn":container.program(3, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "");
  stack1 = ((helper = (helper = helpers.navlinks || (depth0 != null ? depth0.navlinks : depth0)) != null ? helper : helpers.helperMissing),(options={"name":"navlinks","hash":{},"fn":container.program(5, data, 0),"inverse":container.noop,"data":data}),(typeof helper === "function" ? helper.call(alias1,options) : helper));
